...
@extends('layouts.components.auth_main')
@section('auth-title')
    Register
@endsection
    ...
    <section class="form-container">
        ...
        <form action="{{ route('register') }}" enctype="multipart/form-data" method="POST">
            ...
            <input type="password" name="password" id="password" class="box" placeholder="enter your password" required
                autocomplete="new-password">
            <input type="password" name="password_confirmation" id="password_confirmation" class="box" placeholder="confirm your password" required
                autocomplete="new-password">
